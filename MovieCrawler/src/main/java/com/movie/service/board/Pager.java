...
public class Pager {
	...
	public static final int BLOCK_SCASLE=10;
	...
	public void setTotBlock() {
		totBlock = (int)Math.ceil(totPage*1.0 / BLOCK_SCASLE);
	}
	public void setBlockRange() {
		curBlock=(curPage-1)/BLOCK_SCASLE +1;
		blockBegin=(curBlock-1)*BLOCK_SCASLE+1;
		blockEnd=blockBegin+BLOCK_SCASLE-1;
		if(blockEnd > totPage) {
			blockEnd = totPage;
		}
	
		prevPage=(curBlock==1) ? 1 : (curBlock-1)*BLOCK_SCASLE;
		nextPage=curBlock>totBlock ? (curBlock*BLOCK_SCASLE)
				: (curBlock*BLOCK_SCASLE)+1;
	...
	public static int getBlockScasle() {
		return BLOCK_SCASLE;
	}
